...
public class Gui extends JFrame implements ActionListener
{
	...
	private JList<Contact>		roster_list;
	private DefaultListModel<Contact>	roster_list_model;
	...
	public Gui()
	{
        ...
        roster_list_model=new DefaultListModel<Contact>();
        roster_list=new JList<Contact>(roster_list_model);
        menu=new JMenu("STH");
    ...
    void updateContactList(DefaultListModel<Contact> newListModel)
    {
    	roster_list_model=newListModel;
    }
